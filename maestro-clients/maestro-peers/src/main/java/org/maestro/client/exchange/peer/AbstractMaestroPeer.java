...
public abstract class AbstractMaestroPeer<T extends MaestroNote> {
    ...
    protected AbstractMaestroPeer(final String url, final PeerInfo peerInfo, MaestroNoteDeserializer<? extends T> deserializer) throws MaestroConnectionException {
        this.consumerEndpoint = new MqttConsumerEndpoint<T>(url, deserializer, this::noteArrived);
        this.peerInfo = peerInfo;
    }

    protected AbstractMaestroPeer(final ConsumerEndpoint consumerEndpoint, final PeerInfo peerInfo) throws MaestroConnectionException {
